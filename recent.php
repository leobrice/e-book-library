...
<div class="container pt-5 ">
        ...
        <table  class="table table-striped table-bordered" id="example">
            <caption>Recent Added Books</caption>
            <thead class="thead">
                <tr>
                    <th scope="col"> #</th>
                ...
                <tbody>
                    <?php 
                    // sELECT * FROM Books_table order by CreatedAt desc limit 3
                        $book_query=mysqli_query($conn,"SELECT * FROM `Books_table` order by CreatedAt desc limit 3");
                                    $count=1;
