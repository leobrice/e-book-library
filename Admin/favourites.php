...
<body>
  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-nav">
        ...
        <li class="active">
          <a href="./favourites.php?logout"><i class="fa fa-star"></i>Favourites</a>
        </li>
      </ul>
  </aside>
<style>
  ...
  <div id="navbar-wrapper">
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="items-end"> 
        <a href="../logout.php" >Exit <i class="fa fa-power-off"></i></a>
        </div>
      </div>
    </nav>
    </div>
...
<!-- ############################ Start  Change Here  ######################################## -->
        ...
        <tbody>
            <?php
                ...
                $favourites_query=mysqli_query($conn,"SELECT * FROM `Favourites_view` where `Status`=1 ");
                            $count=1;
            ...
            <tr>
                        ...
                        <td> <?php echo $favourites_results['Fav_No']?></td>
                        <td> <?php echo $favourites_results['Username']?></td>
